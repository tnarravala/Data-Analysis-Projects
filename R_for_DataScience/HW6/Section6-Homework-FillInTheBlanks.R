...
colnames(mov2)<-c("Day","Director","Genre","Movie.Title","Release.Date","Studio","Adjusted.Gross","Budget","Gross","IMDB.Rating","MovieLens.Rating","Overseas.Mill","Overseas.Percentage","Profit","Profit.Percentage","Runtime","US.Mill","Gross.US.Percentage")
p <- ggplot(data=mov2, aes(x=Genre, y=Gross.US.Percentage))
